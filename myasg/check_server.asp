...
Dim collItem			'Collezione di ogetti Server.Variables()
...
<!--#include file="includes/header.asp" -->
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
		  <tr align="center" valign="middle">
			<td align="center" background="<%= strAsgSknPathImage & strAsgSknTableBarBgImage %>" bgcolor="<%= strAsgSknTableBarBgColour %>" height="20" class="bartitle"><%= UCase(strAsgTxtServerInformations) %></td>
		  </tr>
		...
		<table width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
		  <tr bgcolor="<%= strAsgSknTableTitleBgColour %>" class="normaltitle">
			<td background="<%= strAsgSknPathImage & strAsgSknTableTitleBgImage %>" align="center" height="16" colspan="2"><%= UCase(strAsgTxtServerInformations) %></td>
		  </tr>
		  <%
		  ...
		  <tr class="smalltext" bgcolor="<%= strAsgSknTableContBgColour %>">
            <td background="<%= strAsgSknPathImage & strAsgSknTableContBgImage %>" width="25%"><%= collItem %></td>
            <td background="<%= strAsgSknPathImage & strAsgSknTableContBgImage %>" width="75%"><%= ShareWords(Request.ServerVariables(collItem), 100) %></td>
          </tr>
		  <%
