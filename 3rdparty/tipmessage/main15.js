...
var Style=[],Info=[],Warning=[],Comment=[],Idea=[],Count=0,move=0,fl=0,isOK=1,hs,e_d,tb,w=window,PX=(MI_pSub)?"px":""
...
//var closeLink=hs==3?"<TD ALIGN='right'><FONT FACE='"+s[4]+"'><A HREF='javascript:void(0)' ONCLICK='mig_hide(0)' STYLE='text-decoration:none; color:"+s[0]+"; font-variant: small-caps; font-size: "+s[5]+";'><B>Close</B></A></FONT></TD>":""
...
var closeLink=hs==3?"<TD ALIGN='right'><A HREF='javascript:void(0)' ONCLICK='mig_hide(0)' title='Close Tip' STYLE='text-decoration:none; color:"+s[0]+"; font-variant: small-caps; font-size: "+s[5]+";'><img src='3rdparty/tipmessage/tip_close.png' border='0' alt='Close Tip' /></A></TD>":""
var title=t[0]||hs==3?"<TABLE WIDTH='100%' BORDER='0' CELLPADDING='5' CELLSPACING='0' "+titBgCol+" "+titBgImg+"><TR><TD "+titTxtAli+"><FONT FACE='"+s[4]+"' "+titCol+" STYLE='font-variant: small-caps; font-size: "+s[5]+";'><B>"+t[0]+"</B></FONT></TD>"+closeLink+"</TR></TABLE>":"";
var txt="<TABLE "+ab+" WIDTH='"+s[12]+"' BORDER='0' CELLSPACING='0' CELLPADDING='"+s[14]+"' "+brdCol+"><TR><TD>"+title+"<TABLE WIDTH='100%' "+tipHeight+" BORDER='0' CELLPADDING='"+s[16]+"' CELLSPACING='0' "+txtBgCol+" "+txtBgImg+"><TR><TD "+txtTxtAli+" "+ap+" VALIGN='top'><FONT FACE='"+s[10]+"' "+txtCol +" style='font-size: "+s[5]+";'>"+t[1]+"</FONT></TD></TR></TABLE></TD></TR></TABLE>"
mig_wlay(txt)
